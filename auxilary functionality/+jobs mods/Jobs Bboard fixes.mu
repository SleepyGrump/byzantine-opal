...
&TRIG_POST [v(JOB_VA)]=@break hasattrp(%0, bbpref_do-not-post); @switch [u(%va/FN_HASATTRP, %0, PLETTER_%1)]=1, {@wait 1={@trigger %vb/TRIG_POST=[get(%0/POST_[default(%0/bboard_dbref, if(u(%va/FN_HASATTRP, %0, transparent), PUBLIC, PRIVATE))])], [switch(%1, APR, A:, DNY, D:, COM, C:, [name(%0)]:)]%b[get(%0/TITLE)], [u(parent(%0)/PLETTER_%1, %0, %1, %2, %3)]};}
