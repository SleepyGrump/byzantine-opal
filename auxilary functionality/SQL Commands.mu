...
&c.+db/hide_table [v(d.sc)]=$+db/hide *:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%0'.; }; @break member(v(d.hidden_tables), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%0' is already hidden.; }; &d.hidden_tables %vD=[setunion(v(d.hidden_tables), %0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%0' has been added to the list of hidden tables. You will no longer see it in +db.; &_current.table %#=;

&c.+db/hide [v(d.sc)]=$+db/hide:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), setr(0, xget(%#, _current.table)), v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%q0'.; }; @break member(v(d.hidden_tables), %q0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%q0' is already hidden.; }; &d.hidden_tables %vD=[setunion(v(d.hidden_tables), %q0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%q0' has been added to the list of hidden tables. You will no longer see it in +db.; &_current.table %#=;

&c.+db/show_table [v(d.sc)]=$+db/show *:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%0'.; }; @assert member(v(d.hidden_tables), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%0' is not currently hidden.; }; &d.hidden_tables %vD=[setdiff(v(d.hidden_tables), %0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%0' has been unhidden. You will now see it in +db.; &_current.table %#=%0;

&c.+db/show [v(d.sc)]=$+db/show:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), setr(0, xget(%#, _current.table)), v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%q0'.; }; @assert member(v(d.hidden_tables), %q0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%q0' is not currently hidden.; }; &d.hidden_tables %vD=[setdiff(v(d.hidden_tables), %q0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%q0' has been unhidden. You will now see it in +db.;

&c.+db/unlock_table [v(d.sc)]=$+db/unlock *:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%0'.; }; @break member(v(d.unlocked_tables), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%0' is already unlocked and visible to players.; }; &d.unlocked_tables %vD=[setunion(v(d.unlocked_tables), %0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%0' has been unlocked. Players can now see it in +db.; &_current.table %#=%0;

@@ Skipping &c.+db/unlock with no table specified because we don't want to risk unsecuring something by accident.

&c.+db/lock_table [v(d.sc)]=$+db/lock *:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%0'.; }; @assert member(v(d.unlocked_tables), %0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%0' is locked and is not currently visible to players.; }; &d.unlocked_tables %vD=[setdiff(v(d.unlocked_tables), %0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%0' has been locked. Players can no longer see it in +db.; &_current.table %#=%0;

&c.+db/lock [v(d.sc)]=$+db/lock:@assert isstaff(%#)={ @trigger me/tr.error=%#, You must be staff to use this function.; }; @assert member(fetch(), setr(0, xget(%#, _current.table)), v(d.default-row-delimiter))={ @trigger me/tr.error=%#, Can't find a table named '%q0'.; }; @assert member(v(d.unlocked_tables), %q0, v(d.default-row-delimiter))={ @trigger me/tr.error=%#, The table '%q0' is locked and is not currently visible to players.; }; &d.unlocked_tables %vD=[setdiff(v(d.unlocked_tables), %q0, v(d.default-row-delimiter))]; @trigger me/tr.success=%#, The table '%q0' has been locked. Players can no longer see it in +db.;
