...
hook_cmd pose permit before after
hook_cmd npose permit before after
hook_cmd : permit before after
hook_cmd ; permit before after
hook_cmd say permit before after
hook_cmd nsay permit before after
hook_cmd " permit before after
hook_cmd @emit permit before after
hook_cmd \ permit before after
hook_cmd @remit permit before after
...
+duty
+dark
+join &lt;nameand +rjoin or +return or something cuz I always forgot that command
+summon &lt;nameand +rsummon or +return &lt;name
+selfboot
