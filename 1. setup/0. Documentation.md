...
+parent here=ic, ooc, residential, or non-residential - mark a location IC/OOC/etc. Residential rooms are special - they're set ABODE and UNFINDABLE by default. All other options are !ABODE and !UNFINDABLE. Owners of buildings can +private them to change that.

You can tell which parent a room is parented to by looking at the room as staff - all staffers will see OOC, IC, Residential, and Non-residential in the header of the room.

+digging a new room will set the parent to the existing room's parent - so if you dig something in the OOC room, it'll be OOC, while IC and Residential will make the next room Residential.
